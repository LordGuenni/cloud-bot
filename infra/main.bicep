...
resource webApp 'Microsoft.Web/sites@2022-03-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appCommandLine: 'cd /home/site/wwwroot && python -m pip install --upgrade pip && python -m pip install -r requirements.txt && python -m uvicorn app.main:app --host 0.0.0.0 --port 8000'
      alwaysOn: true
      appSettings: [
        {
